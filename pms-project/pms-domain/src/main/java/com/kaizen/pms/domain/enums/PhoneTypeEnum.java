...
public enum PhoneTypeEnum {
	...
	PhoneTypeEnum(int value, String text, String description) {
		this.value = value;
		this.text = text;
	 ...
	 */
	public static PhoneTypeEnum fromString(String text) {
		
		PhoneTypeEnum result = null;
		
		if(text != null && !text.isEmpty()) {
			for(PhoneTypeEnum elm : PhoneTypeEnum.values()) {
	 ...
	 */
	public static PhoneTypeEnum fromValue(int value) {
